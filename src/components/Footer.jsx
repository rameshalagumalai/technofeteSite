  ...
  return (
    <div className="footer d-flex align-items-center section text-white row">
      <div className="col-md-6">
        ...
        <p className="mb-0 text-start">An intra-college event organized by the Students' Guild of Service, Dr.Mahalingam College of Engineering and Technology</p>
      ...
      <div className="col-md-3 footer-div">
        ...
        <a className="text-white d-block mb-2" href="https://nimalan.vercel.app/" rel="noreferrer" target="_blank"><i className="fa-solid fa-globe me-2"></i>Nimalan S (IV CSE) <i className="fa-solid fa-arrow-up-right-from-square text-primary"></i></a>
        <a className="text-white d-block mb-2" href="https://rameshalagumalai.com" rel="noreferrer" target="_blank"><i className="fa-solid fa-globe me-2"></i>Ramesh A (IV CSE) <i className="fa-solid fa-arrow-up-right-from-square text-primary"></i></a>
      </div>
    </div>
  );
}
